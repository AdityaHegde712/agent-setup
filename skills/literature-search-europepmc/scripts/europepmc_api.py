...
def main():
    ...
    p_cit.add_argument("--page_size", type=int, default=25, help="Results per page")
    ...
    p_ref.add_argument("--page_size", type=int, default=25, help="Results per page")
    ...
    if args.command == "search":
        ...
        result = get_citations(args.source, args.article_id, args.page, args.page_size)
        write_output(result, args.output)
        print(
        ...
        result = get_references(args.source, args.article_id, args.page, args.page_size)
        write_output(result, args.output)
        print(
